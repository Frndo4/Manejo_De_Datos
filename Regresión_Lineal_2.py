...
def generador_datos_simple(beta, muestras, desviacion): #Genero n (muestras) valores de x alea
    x = np.random.random(muestras) * 100 #Genero un error aleatorio gaussiano con desviación t
...
#Creo modelo de regresión lineal 
