...
#Cargar BD
url=r'C:\Users\fer-j\Documents\Python\Inteligencia_Artificial\Manejo_de_Datos\nba-players.csv'
...
X=datos[['gp','min','pts','fgm','fga','fg','3p_made','3pa','3p','ftm','fta','ft','oreb','dreb','reb','ast','stl','blk','tov']]
y=datos[['target_5yrs']]
